...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($_FILES['photo']['name'])) {
        ...
        if (!in_array($file['type'], $allowed)) {
            ...
            $photo = uniqid('doula_', true) . '.' . $ext;
            if (!move_uploaded_file($file['tmp_name'], UPLOAD_DIR . $photo)) {
    ...
    if (!$errors) {
        ...
        try {
            $pdo->prepare('
                INSERT INTO doulas
                    (name, bio, photo, certifications, years_experience, email, phone, website,
                     city, country, latitude, longitude, is_active, created_at, updated_at)
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW(), NOW())
            ')->execute([$name, $bio ?: null, $photo, $certs ?: null, $years, $email ?: null,
                         $phone ?: null, $website ?: null, $city, $country, $lat, $lng, $active]);
            ...
            $pdo->commit();
            $_SESSION['flash'] = ['type' => 'success', 'message' => "\"$name\" has been added."];
...
<div class="d-flex align-items-center gap-2 mb-4">
    ...
    <h2 class="h4 mb-0 fw-semibold">Add Doula</h2>
</div>
...
<form method="POST" enctype="multipart/form-data" novalidate>
        ...
        <div class="card-body">
            <div class="mb-3">
                ...
                <textarea name="certifications" class="form-control" rows="3"
                          placeholder="e.g. Certified by INELDA 2022"><?= htmlspecialchars($old['certifications'] ?? '') ?></textarea>
            </div>
            <div>
    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <input type="text" name="latitude" inputmode="decimal"
                           ...
                           placeholder="e.g. 59.3293" value="<?= htmlspecialchars($old['latitude'] ?? '') ?>">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <input type="text" name="longitude" inputmode="decimal"
                           ...
                           placeholder="e.g. 18.0686" value="<?= htmlspecialchars($old['longitude'] ?? '') ?>">
            ...
            <p class="form-text mt-2">
                ...
                Right-click any location on <a href="https://maps.google.com" target="_blank" rel="noreferrer">Google Maps</a>
                and select "What's here?" to copy coordinates.
            </p>
        </div>
    </div>
            ...
            <div class="d-flex flex-wrap gap-2">
                ...
                <div class="form-check">
                    <input type="checkbox" class="form-check-input" name="categories[]"
                           ...
                           <?= in_array($cat['id'], array_map('intval', $old['categories'] ?? [])) ? 'checked' : '' ?>>
                    ...
                    <div class="col">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" name="languages[]"
                                   ...
                                   <?= in_array($l['id'], array_map('intval', $old['languages'] ?? [])) ? 'checked' : '' ?>>
    ...
    <div class="d-flex gap-2 mb-5">
        <button type="submit" class="btn btn-dark px-4">
            <i class="bi bi-check-lg me-1"></i> Save Doula
        </button>
